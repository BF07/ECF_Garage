      ...
      <>
        ...
        <nav className="navbar-desktop">
                <div className="nav-links">
                    <a href="/ventes" className="nav-link">Nos occasions</a>
                    <a href="/ventes" className="nav-link">Entretien</a>
                    <a href="/ventes" className="nav-link">Mécanique</a>
                    <a href="/ventes" className="nav-link">Carrosserie</a>
                ...
                <SearchBar className="search-bar" search={search} onSearchChange={setSearch} />
                <FontAwesomeIcon className="search-font" icon={faMagnifyingGlass} />
                    <a href="/se-connecter">
