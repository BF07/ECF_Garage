...
import "./homepage.css"
import FormFilterCar from "../../components/Forms/FormFilterCar.jsx";
import Navbar from "../../components/Navbar/Navbar.jsx";
import Button from "../../components/Buttons/LandpageButton.jsx"
...
export default function Homepage () {
  ...
  const preloadImages = async () => {
    await Promise.all(variantsImages.map((variant) => {loadImage(variant.image)}))
  }
  ...
  const changeBackground = (newBackgroundIndex) => {
